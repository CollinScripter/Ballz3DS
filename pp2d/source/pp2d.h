...
#define PP2D_MAX_VERTICES 999999 //Set a real number here, this works for now
...
/**
  * @brief Creates a circle (by Collin Dewey)
  * @param cx x of circle center
  * @param cy y of circle center
  * @param r radius of circle
  * @param color of circle
  * @param num_segments of circle
  */
void pp2d_draw_circle(float cx, float cy, float r, u32 color, int num_segments);

/**
  * @brief Returns verticies used (by Collin Dewey)
  */
size_t pp2d_get_verticies();

/**
 * @brief Draws a square
 * @param x of the top left corner
 * @param y of the top left corner
 * @param width and height on the square
 * @param color RGBA8 to fill the square
 */
void pp2d_draw_square(int x, int y, int size, u32 color);
